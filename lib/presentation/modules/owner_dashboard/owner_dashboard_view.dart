...
class OwnerDashboardView extends GetView<OwnerController> {
        ...
        child: SafeArea(
          child: CustomScrollView(
            ...
            slivers: [
              ...
              _buildDeveloperMatchesSection(context),
      ...
      if (controller.myProjects.isEmpty) {
        return SliverFillRemaining(
          ...
          child: AppEmptyState(
            ...
            subtitle:
                'Go to the "Create" tab to launch your first project and start matching.',
          ),
        );
      }
  ...
  Widget _buildDeveloperMatchesSection(BuildContext context) {
    return Obx(() {
      if (controller.selectedProject.value == null ||
          controller.developerMatches.isEmpty) {
              ...
              if (controller.isFindingDevelopers.value)
                ...
                ...controller.developerMatches.asMap().entries.map(
                  (e) => Padding(
                    ...
                    child: _DeveloperMatchCard(match: e.value, index: e.key),
                  ),
                ),
            ],
          ),
              ...
              children: [
                ...
                Row(
                  children: [
                    ...
                    const Spacer(),
                    Obx(() {
                      final ctrl = Get.find<OwnerController>();
                      final count = ctrl.pendingJoinRequests[project.id] ?? 0;
