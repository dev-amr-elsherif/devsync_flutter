  ...
  Widget _buildHeader() {
    return Column(
      ...
      children: [
        ...
        Text(
          'Describe your technical vision or use a shortcut.',
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  ...
                  Obx(
                    () => IconButton.filled(
                      onPressed: controller.isRefining.value
                          ? null
                          : controller.refineProjectWithAI,
                ...
                children: [
                  Expanded(
                    child: TextField(
                      ...
                      // ✅ FIX: removed const — AppTheme.textPrimary is a getter
                      style: TextStyle(
              ...
              .map(
                (s) => Obx(() {
                  ...
                  return GestureDetector(
                    onTap: () => isAdded
                        ? controller.removeTech(s)
                        : controller.addTech(s),
                    child: AnimatedContainer(
                      ...
                      decoration: BoxDecoration(
                        ...
                        border: Border.all(
                          color: isAdded ? AppTheme.primary : Colors.white12,
                        ),
                      ),
                      child: Text(
                        s,
